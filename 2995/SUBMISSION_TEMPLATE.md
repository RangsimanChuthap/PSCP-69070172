...
```text
Step 1: กำหนดรับ Input เป็น ตัวเลข ID
Step 2: เช็คหลักที่ 3 และ 4 ว่าเป็นเลข 1 และ 6 ตามลำดับ
Step 3: ถ้าใช่ print("yes") ถ้าไม่ใช่ print("no")
```
...
```text
Step 1: กำหนดรับ Input เป็น ตัวเลข ID
Step 2: เช็คหลักที่ 3 และ 4 โดยใช้ index เช็คหลักว่าเป็นเลข 1 และ 6 ตามลำดับ
Step 3: ถ้าใช่ print("yes") ถ้าไม่ใช่ print("no")
```
