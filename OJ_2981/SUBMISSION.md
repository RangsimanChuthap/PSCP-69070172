...
```text กำหนด input เป็นชื่อ-สกุล แล้ว output บรรทัดแรกเป็น "Hello <ชื่อ> <สกุล>" และบรรทัดที่ 2 เป็น "2 ตัวอักษรแรกของชื่อและสกุลเชื่อมต่อกัน"
```
...
```text
Step 1: กำหนดรับ Input เป็น ชื่อ และ สกุล ตามลำดับ
Step 2: print "Hello <ชื่อ> <สกุล>"
Step 3: print ชื่อและสกุล 2 ตัวอักษรแรกโดยใช้ index ([])
```
