...
ของเครื่องผม (ซึ่งไม่ได้ sync กับ repo ในเว็บ) และประวัติ commit ของที่แก้ผ่านเว็บก็หายไปด้วย(ย้อนกลับไม่ได้) นอกจากนั้น ผม commit ผ่าน force ตลอด repo ของในเครื่อง กับของใน github เลยไม่ sync กัน ผมเลยต้องรีเซ็ต repo เพื่อให้มันกลับมาใช้ได้ ฉะนั้น ไฟล์ทุกอันเลยจะมี timestamp รีเซ็ตหมด ขอโทษครับ 😭😭🙏
